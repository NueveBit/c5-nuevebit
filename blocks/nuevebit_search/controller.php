...
class NuevebitSearchBlockController extends BlockController {
	
	protected $btTable = 'nuevebit_btSearch';
	...
	public function getBlockTypeDescription() {
		return t("Add a search box to your site. Uses Pages instead of IndexedSearchResults for results.");
	}
	
	public function getBlockTypeName() {
		return t("Nuevebit Search");
	}		
...
//		$ipl->setSimpleIndexMode(true);
        ...
        // TODO: Esto no debe ir aquí
        $ipl->filterByCollectionTypeHandle('news_entry');
