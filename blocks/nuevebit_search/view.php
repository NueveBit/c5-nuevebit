...
if ($do_search) {
	...
	<?php  }else{ ?>
		...
		<?php  foreach($results as $r) { 
            $url = $nh->getLinkToCollection($r, true);
			?>
			<div class="searchResult">
				<h3><a href="<?php echo $url?>"><?php echo $r->getCollectionName()?></a></h3>
				<p>
					...
					<?php  } ?>
					<a href="<?php   echo $url; ?>" class="pageLink"><?php   echo $this->controller->highlightedMarkup($url,$query)?></a>
				</p>
			</div>
